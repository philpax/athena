...
void dumpOperand(Operand* operand, OpcodeType type = OpcodeType.FLOAT)
{
...
void dumpDeclaration(Declaration* declaration)
{
...
void dumpInstruction(Instruction* instruction)
{
	...
	foreach (index, operand; instruction.operands.enumerate())
	{
		...
		write(' ');
		operand.dumpOperand(OpcodeTypes[instruction.opcode]);
	}
